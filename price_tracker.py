"""
Afloral Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Afloral.

Docs  : https://docs.bright.cn/scraping-automation/web-scraper-api/overview
Info  : https://bright.cn/products/insights/price-tracker/afloral
"""
...
# Set your Web Scraper ID after building your Afloral scraper:
# https://bright.cn/products/web-scraper/afloral
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Afloral scraper at: https://bright.cn/products/web-scraper/afloral\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Afloral product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Afloral products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Afloral category page.

    Example:
        results = discover_by_category("https://afloral.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.afloral.com/product/sample-item-123456",
        # Add more Afloral product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "afloral_prices.json"
    ...
    # cat_results = discover_by_category("https://afloral.com/category/sample", limit=50)
